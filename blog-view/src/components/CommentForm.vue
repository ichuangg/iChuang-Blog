        ...
        <el-row :gutter="20">
          <el-col :span="6">
            <el-form-item prop="nickname">
              <el-popover ref="nicknamePopover" content="输入QQ号将自动拉取昵称和头像" placement="bottom"
                          trigger="focus"></el-popover>
              <el-input v-model="commentForm.nickname" v-popover:nicknamePopover :validate-event="false"
                        placeholder="昵称（必填）"
                        @blur="onInputBlur">
          ...
          <el-col :offset="1" :span="5">
            <el-form-item>
              <!-- 接口节流  -->
              <el-button size="medium" type="primary" v-throttle="[postForm,`click`,30000]"
                         @mouseenter.native="beforePost">发表评论
              </el-button>
            </el-form-item>
          </el-col>
        </el-row>
