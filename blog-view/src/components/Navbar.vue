<template>
  <div class="blog-navbar" :class="{'transparent':$route.name==='Home' }">
    ...
    <router-link style="text-decoration-line: none;color: white" to="/">
      <h3 :class="{'m-display-none': mobileHide,'active':$route.name==='About'}"
          class="ui header item m-blue" style="display: inline;padding:20px 20px 20px 60px">iChuang's
        Blog</h3>
    </router-link>
    ...
    <router-link :class="{'m-display-none': mobileHide,'active':$route.name==='Archives'}" class="item" style="text-decoration-line: none;color: white;padding:20px"
                 to="/archives">
      归档
    </router-link>

    <router-link :class="{'m-display-none': mobileHide,'active':$route.name==='Friends'}" class="item" style="text-decoration-line: none;color: white;padding:20px"
                 to="/friends">
      友链
    </router-link>
    <router-link :class="{'m-display-none': mobileHide,'active':$route.name==='About'}" class="item" style="text-decoration-line: none;color: white;padding: 20px"
                 to="/about">
      关于我
    </router-link>
