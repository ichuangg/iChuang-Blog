...
export default {
  ...
  methods: {
    //跳转到个人github
    goToGithub() {
      window.location.href = "https://github.com/iChuangCoder/"
    },
    goMusic(){
      window.location.href = "https://music.163.com/#/user/home?id=413610864"
    }
  },
  created() {
  }
